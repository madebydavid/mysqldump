...
function getProcedureDump(connection, dbName, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        result
            ...
            sql = [
                '# ------------------------------------------------------------',
                `# STORED PROCEDURE DUMP FOR: ${res.Procedure}`,
                '# ------------------------------------------------------------',
                '',
                sql,
                '',
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (options.dump.procedure !== false) {
                const procedures = yield getProcedureDump(connection, options.connection.database, options.dump.procedure);
            ...
            if (options.dumpToFile && res.dump.procedure) {
                appendFileSync(options.dumpToFile, `${res.dump.procedure}\n\n`);
            }
